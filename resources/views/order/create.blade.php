                ...
                <div class="modal-body">
                    <div style="margin-left:5%;margin-right:5%;">
                        <div style="height: 36em;overflow: scroll;font-size:0.9em">
                            <h3>用户服务协议</h3>
                            <p>
                                北京闪银奇异科技有限公司（以下称“我司”）根据您的使用需求向您提供分时租房服务，您访问和使用有关网站、服务、微信公众号、应用程序提供的分时房间预约服务适用本用户服务协议（以下简称“协议”）。
                            </p>
                            提示条款
                            <p>
                                【审慎阅读】您在申请注册流程中点击同意本协议之前，应当认真阅读本协议。请您务必审慎阅读、充分理解各条款内容，特别是免除或者限制责任的条款、法律适用和争议解决条款。免除或者限制责任的条款将以粗体下划线标识，您应重点阅读。如您对协议有任何疑问，可向ITopia平台客服咨询。
                            </p>
                            <p>
                            【签约动作】当您按照注册页面提示填写信息、阅读并同意本协议且完成全部注册程序后，即表示您已充分阅读、理解并接受本协议的全部内容，并与ITopia达成一致，成为ITopia分时空间平台的用户。阅读本协议的过程中，如果您不同意本协议或其中任何条款约定，您应立即停止注册程序。
                            </p>
                            <h5>第一条 合同订立</h5>
                            <p>
                                本协议由您与ITopia分时空间平台的出租方同缔结，本协议对您与ITopia的出方均具有合同效力。您理解并同意，您通过ITopia平台使用我司的服务，即视为接受本《用户服务协议》并依据本协议与我司达成了合约。
                            </p>
                            <h5>第二条 用户注册</h5>
                            2.1如您申请使用我司提供的服务，请您在微信中关注“ITopia分时空间”微信公众号，或者下载我司提供的相关应用程序进行用户注册，注册时您必须保证提供真实有效的身份证明、移动电话号码等基本信息。您可以通过程序注册、手机验证等步骤注册成为ITopia平台注册用户，并拥有自己的账户。在使用过程中，您不得转让该账户，也不得许可或者协助他人使用您的账户使用预约服务，否则由此产生的一切责任均由您承担连带责任。
                            <br>
