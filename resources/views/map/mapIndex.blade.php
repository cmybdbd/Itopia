...
@section('content')
    ...
    <div style="position:fixed;width:100%;bottom:5%;">
        <div id="day" class="circle" style="text-align:center;position:absolute;bottom:0%;left:55px">
        ...
        <div id="night" class="circle" style="text-align:center;position:absolute;bottom:0%;right:55px">
